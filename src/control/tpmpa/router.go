...
func initRouters() {
	...
	beego.Router("/api/v1/route_show", &api.TuplenetAPI{}, "post:ShowRouter")
	...
	beego.Router("/api/v1/route_port_show", &api.TuplenetAPI{}, "post:ShowRouterPort")
	...
	beego.Router("/api/v1/route_static_show", &api.TuplenetAPI{}, "post:ShowStaticRoute")
	...
	beego.Router("/api/v1/route_nat_show", &api.TuplenetAPI{}, "post:ShowNAT")
	...
	beego.Router("/api/v1/switch_show", &api.TuplenetAPI{}, "post:ShowSwitch")
	...
	beego.Router("/api/v1/switch_port_show", &api.TuplenetAPI{}, "post:ShowSwitchPort")
