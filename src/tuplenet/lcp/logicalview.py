...
pyDatalog.create_terms('lroute_array, lnat_array')
pyDatalog.create_terms('Route, Route1, Route2, Route3')
...
pyDatalog.create_terms('UUID_LR_CHASSIS, UUID_LR_CHASSIS1, UUID_LR_CHASSIS2')
...
pyDatalog.create_terms('Match6, Match7, Match8, Match9, Match10')
pyDatalog.create_terms('Priority1, Priority2, Priority3, Priority4')
